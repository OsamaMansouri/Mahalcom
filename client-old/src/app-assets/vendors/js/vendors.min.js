...
!(function (e, t) {
      ...
      return (
        ...
        ce(function (r, a, s, l) {
          var c,
            ...
            m = n ? (o || (r ? e : d || i) ? [] : a) : y;
          if ((n && n(y, m, s, l), i))
            for (c = _e(m, h), i(c, [], s, l), u = c.length; u--; )
              (p = c[u]) && (m[h[u]] = !(y[h[u]] = p));
          if (r) {
            if (o || e) {
              if (o) {
  ...
  function be(e, t, n, i, o) {
    ...
    for (p.textContent = "", h = 0; (r = f[h++]); )
      if (i && -1 < w.inArray(r, i)) o && o.push(r);
        ...
        ((c = oe(r)), (a = ye(p.appendChild(r), "script")), c && me(a), n)
      )
      ...
      if (y && (l = y.events)) {
        for (c = (t = (t || "").match(I) || [""]).length; c--; )
          if (
            ...
            a &&
              !f.length &&
              ((p.teardown && !1 !== p.teardown.call(e, d, y.handle)) ||
                w.removeEvent(e, h, y.handle),
              delete l[h]);
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && C(t, "input") && Ce(t, "click", ke),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            fe.test(t.type) && t.click && C(t, "input") && Ce(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Ie(e, t, n, i) {
    ...
    if (
      ...
      for (l = (s = w.map(ye(o, "script"), Me)).length; p < f; p++)
        (c = o),
          p !== g &&
            ((c = w.clone(c, !0, !0)), l && w.merge(s, ye(c, "script"))),
          n.call(e[p], c, p);
      if (l)
  ...
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (r = r || ye(e), a = a || ye(u), i = 0, o = r.length; i < o; i++)
            De(r[i], a[i]);
        else De(e, u);
      return (
        0 < (a = ye(u, "script")).length && me(a, !p && ye(e, "script")), u
      );
    },
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = Ye(s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 === n)
        )
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : dt.test(e.nodeName) || (gt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
  ...
  w.extend(w.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        if (!o && !f.noBubble && !g(i)) {
          for (
            l = f.delegateType || v, xt.test(l + v) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            m.push(a), (s = a);
  ...
  w.ajaxSetup({
    ...
    (h.createHTMLDocument =
      (((Xt = y.implementation.createHTMLDocument("").body).innerHTML =
        "<form></form><form></form>"),
  ...
  (function (e, t, n, i) {
    ...
    (z.prototype = {
      ...
      requireFailure: function (e) {
        ...
        return (
          -1 === m(t, (e = X(e, this))) && (t.push(e), e.requireFailure(this)),
          this
        );
      },
      ...
      x = {
        ...
        w = function () {
          ...
          for (
            t = arguments[0],
              r = 0,
              a = (i = 2 <= arguments.length ? $.call(arguments, 1) : [])
                .length;
            a > r;
            r++
          )
        ...
        y = function (e) {
          var t, n, i, o, r;
          for (n = t = 0, o = 0, r = e.length; r > o; o++)
            (i = e[o]), (n += Math.abs(i)), t++;
          return n / t;
        },
        k = function (e, t) {
          var n, i, o;
    ...
    (l = (function (e) {
          ...
          (e.prototype.render = function () {
            ...
            for (
              e = this.getElement(),
                ...
                o = 0,
                r = (a = ["webkitTransform", "msTransform", "transform"])
                  .length;
              r > o;
              o++
            )
        ...
        return (
          (e.prototype.trigger = function (e, t) {
            ...
            if (null != this.bindings[e]) {
              for (a = [], i = 0, o = (r = this.bindings[e]).length; o > i; i++)
            ...
            (e = function (e) {
              ...
              return (
                ...
                (e.open = function (i, o) {
                  return (
                    I(i) &&
                      n.trigger("request", { type: i, url: o, request: e }),
                    t.apply(e, arguments)
                  );
                })
              );
      ...
      (E = function () {
        ...
        return (
          ...
          D(a) ||
          c.running ||
          (!1 === L.restartOnRequestAfter && "force" !== I(r))
            ? void 0
            : ((i = arguments),
              ...
              setTimeout(function () {
                ...
                if (
                  "socket" === r
                    ? o.readyState < 2
                    : 0 < (a = o.readyState) && 4 > a
                ) {
                  for (
                    c.restart(), l = [], t = 0, n = (s = c.sources).length;
                    n > t;
                    t++
                  ) {
        ...
        if (((this.progress = 0), null != window.ProgressEvent))
          for (
            e.addEventListener(
              "progress",
              function (e) {
                return (a.progress = e.lengthComputable
      ...
      (C = function () {
        ...
        for (
          i = 0, r = (l = null != (s = L.extraSources) ? s : []).length;
          r > i;
          i++
        )
          (P = l[i]), R.push(new P(L));
      ...
      (c.go = function () {
        ...
        return (
          ...
          (g = M(function (t, n) {
            ...
            for (
              100 - m.progress, o = d = 0, r = !0, l = g = 0, b = R.length;
              b > g;
              l = ++g
            )
              for (
                P = R[l],
                  h = null != j[l] ? j[l] : (j[l] = []),
                  u = y = 0,
                  x = (s = null != (w = P.elements) ? w : [P]).length;
                x > y;
                u = ++y
              )
                (a = s[u]),
      ...
      function (e, t, n) {
        ...
        e.exports = function (e) {
          ...
          if (
            ...
            for (p = v.call(f), n = new h(); !(u = p.next()).done; m++)
          ...
          if (
            (L &&
              ...
              d !== Object.prototype &&
                ...
                (p ||
                  r(x) === d ||
                  (a ? a(x, d) : "function" != typeof x[y] && l(x, y, m)),
                s(x, E, !0, !0),
                p && (f[E] = m))),
            "values" == h &&
              C &&
