        ...
        <Grid item xs={12}>
          <Stack spacing={1}>
            ...
            <FormControl fullWidth error={!!errors.id_supplier}>
              <Select name="id_supplier" value={formData.id_supplier} onChange={handleChange} onBlur={handleBlur} displayEmpty required>
              ...
              <Grid container spacing={2} alignItems="center" key={index}>
                <Grid item xs={3}>
                  <FormControl fullWidth error={!!errors[`products[${index}].product_id`]}>
                    ...
                    {errors[`products[${index}].product_id`] && <FormHelperText>{errors[`products[${index}].product_id`]}</FormHelperText>}
                  </FormControl>
                </Grid>
                <Grid item xs={2}>
                  <TextField
