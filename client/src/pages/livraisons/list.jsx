...
export default function LivraisonList() {
  ...
  const handleEditClick = (livraison) => {
    ...
    setEditedLivraison({
      ...livraison,
      id_livreur: livraison.id_livreur?._id || ''
    });
          ...
          <TableBody>
            {livraisons.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, index) => (
              <TableRow hover key={row._id}>
                ...
                <TableCell>{row.id_livreur?.fname || '-'}</TableCell>
                ...
                <Grid container spacing={2} alignItems="center">
                  <Grid item xs={8}>
                    <Stack spacing={1}>
                      ...
                      <TextField fullWidth name="livreur" value={selectedLivraison?.id_livreur?.fname || ''} readOnly />
                    </Stack>
                  </Grid>
                  <Grid item xs={4}>
                    <Stack spacing={1}>
                  ...
                  <Grid item xs={8}>
                    <Stack spacing={1}>
                      ...
                      <FormControl fullWidth>
                        <Select name="id_livreur" value={editedLivraison.id_livreur || ''} onChange={handleFieldChange} displayEmpty>
